...
export default function Page() {
  ...
  return (
    <Slide>
      ...
      <Title2>Traduções</Title2>

      <Paragraph>
        A API de traduções recebe como entrada o arquivo de áudio em qualquer um
        dos idiomas suportados e transcreve, se necessário, o áudio para o
        inglês. Isso difere do endpoint de transcrições, pois a saída não está
        no idioma original de entrada e, em vez disso, é traduzida para texto em
        inglês.
      </Paragraph>
